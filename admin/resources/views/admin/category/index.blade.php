...
<div class="topbar-right">
    <a href="{{url('category/add')}}" class="btn btn-default btn-sm light fw600 ml10">
                ...
                <div class="panel panel-visible" id="spy2">
                    <div class="panel-heading">
                        <div class="panel-title hidden-xs">
                            <span class="glyphicon glyphicon-tasks"></span>Category</div>
                    </div>
                    ...
                    <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                        ...
                        @foreach ($categorydata as $list)
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ url('category/add/') }}/{{ $list->id }}" class="btn btn-warning btn-xs">
